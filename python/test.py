...
if __name__ == "__main__":
   if sys.argv[1].strip() == "sp1":
      ...
      print("Average time is {} ns across {} inputs. Total avg is {}".format(timeSum/len(arr["p1_1"]), len(arr["p1_1"]), (endT-startT)/len(arr["p1_1"])))


   if sys.argv[1].strip() == "sp2":
...
if sys.argv[1].strip() == "sp4":
      ...
      for i in range(len(arr["p_1"])):
         ...
         #print("Calculated is: {}, Actual is: {}".format(theta[0:2], str(arr["theta1"][i]) + " " + str(arr["theta2"][i])))
      endT = time.perf_counter_ns()
      print("Average time is {} ns across {} inputs. Total avg is {}".format(timeSum/len(arr["p_1"]), len(arr["p_1"]), (endT-startT)/len(arr["p_1"])))


if sys.argv[1].strip() == "sp5":
