classdef IK_spherical_2_intersecting
    % h_1 intersects with h_2
    ...
    methods (Static)
        ...
        function S = run(P)
            [S.Q, S.is_LS] = IK.IK_spherical_2_intersecting(P.R, P.T, P.kin);
        end

        function S = run_mex(P)
            [S.Q, S.is_LS] = IK.IK_spherical_2_intersecting_mex(P.R, P.T, P.kin);            
        end

        function generate_mex()
            P = IK_setups.IK_spherical_2_intersecting.setup(); %#ok<NASGU> 
