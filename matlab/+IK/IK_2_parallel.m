...
for i_q1 = 1:length(q1_vec)
    ...
    [q2, q2_is_ls] = subproblem.sp_1(kin.P(:,3), ...
        R_01'*p_16 - kin.P(:,2) - R_13*kin.P(:,4) - R_13*R_34*kin.P(:,5) - R_01'*R_06*R_56'*kin.P(:,6), ...
        kin.H(:,2));
...
function [e, t4, t6]  = error_given_q1(q1)
    ...
    d1 = kin.H(:,2)'*(R_01'*p_16 - kin.P(:,2) - kin.P(:,3) - kin.P(:,4));
    d2 = 0;
    ...
    for i_46 = 1:length(t4)
        ...
        e(i_46) = ...
            norm(R_01'*p_16 - kin.P(:,2) - R_13*kin.P(:,4) - R_13*R_34*kin.P(:,5) - R_01'*R_06*R_56'*kin.P(:,6))...
            - norm(kin.P(:,3));
    end
end
